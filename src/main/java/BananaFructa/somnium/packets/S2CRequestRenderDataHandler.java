...
@OnlyIn(Dist.CLIENT)
public class S2CRequestRenderDataHandler {
    ...
    public static void handle(S2CRequestRenderData packet) {
        Minecraft.getInstance().execute(() -> {
            ...
            try {
                ...
                PacketRegistry.toServer(new C2SRenderData(packet.CoACaller, scaled.asByteArray()));
            } catch (IOException e) {
